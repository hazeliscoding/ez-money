...
> review/test gate (worth keeping while builds are unsigned and not GUI-tested in CI).
...
- **Unsigned builds:** Windows SmartScreen warns on install, and auto-install is
  best-effort until the installer is code-signed.
